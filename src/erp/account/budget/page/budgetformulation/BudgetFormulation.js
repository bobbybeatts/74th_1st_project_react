...
const BudgetFormulation = () => {
    ...
    // const [currentBudgetList, setcurrentBudgetList] = useState('');
    ...
    const budgetList = useSelector((state) => state.RootReducers.AccReducer.BaseReducer.currentBudgetList);
    ...
    const searchBudgetList = () => {
        dispatch({
            type: types.SEARCH_CURRENT_BUDGET_REQUEST,
            params: {
                deptCode: deptCode,
    ...
    const onReset = () => {
        month1.value = budgetList[0].m1Budget;
        month2.value = budgetList[0].m2Budget;
        month3.value = budgetList[0].m3Budget;
        month4.value = budgetList[0].m4Budget;
        month5.value = budgetList[0].m5Budget;
        month6.value = budgetList[0].m6Budget;
        month7.value = budgetList[0].m7Budget;
        month8.value = budgetList[0].m8Budget;
        month9.value = budgetList[0].m9Budget;
        month10.value = budgetList[0].m10Budget;
        month11.value = budgetList[0].m11Budget;
        month12.value = budgetList[0].m12Budget;
        // setYear('');
        // setWorkplace('');
        // setDname('');
        ...
        <Grid container spacing={gridSpacing}>
            ...
            <Grid item sm={6}>
                <MainCard
                    ...
                    title="예산신청조회"
                    secondary={
                        <Button variant="contained" color="secondary" startIcon={<AddCircleIcon />} onClick={searchBudgetList}>
                            조회
                        </Button>
                    }
                >
            ...
            <Grid item sm={6}>
                <MainCard
                    ...
                    title="예산편성"
                    secondary={
                        <Button variant="contained" color="secondary" startIcon={<AddCircleIcon />} onClick={onReset}>
                            등록
                        </Button>
                    }
                >
                    ...
                    >
                        <TextField id="organization1" label="1월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization2" label="2월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization3" label="3월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization4" label="4월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization5" label="5월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization6" label="6월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization7" label="7월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization8" label="8월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization9" label="9월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization10" label="10월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization11" label="11월" autoComplete="current-password" onChange={insertMonthBudget} />
                        <TextField id="organization12" label="12월" autoComplete="current-password" onChange={insertMonthBudget} />
                    </Box>
                </MainCard>
            </Grid>
        </Grid>
